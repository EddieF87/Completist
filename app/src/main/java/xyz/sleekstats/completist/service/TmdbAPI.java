...
public interface TmdbAPI {
    ...
    @GET("movie/{movie_id}?api_key=b5f45c3ea3adf1ca53b96fa5bb9394d2&language=en-US&append_to_response=credits&include_adult=false")
    Single<FilmPOJO> retrieveFilm(
            @Path("movie_id") String movie_id
    );

    //Query for specific tv show details based on Tmdb show id
    @GET("tv/{show_id}?api_key=b5f45c3ea3adf1ca53b96fa5bb9394d2&language=en-US&append_to_response=credits&include_adult=false")
    ...
    @GET("person/{person_id}?api_key=b5f45c3ea3adf1ca53b96fa5bb9394d2&append_to_response=movie_credits,tv_credits&include_adult=false")

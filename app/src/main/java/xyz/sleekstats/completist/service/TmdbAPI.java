...
public interface TmdbAPI {
    ...
    @GET("movie/{movie_id}?api_key=" + API_KEY + "&language=en-US&append_to_response=credits,similar" +
    ...
    @GET("tv/{show_id}?api_key=" + API_KEY + "&language=en-US&append_to_response=credits,similar" +
            "&include_adult=false&language=en-US")
    ...
    @GET("discover/{tvOrMovie}?api_key=" + API_KEY + "&sort_by=popularity.desc" +
            "&include_adult=false&language=en-US")
